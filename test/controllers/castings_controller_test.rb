...
class CastingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create casting" do
    assert_difference('Casting.count') do
      post castings_url, params: { casting: { actor_id: @casting.actor_id, movie_id: @casting.movie_id } }
    end
  ...
  test "should update casting" do
    patch casting_url(@casting), params: { casting: { actor_id: @casting.actor_id, movie_id: @casting.movie_id } }
